...
export default function AppointmentArea() {
    return (
        <section id="appointment" className="ls section_padding_top_130 section_padding_bottom_100">
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
                        <h2 className="section_header with_icon highlight">Make an Appointment</h2>
                        ...
                        <form className="contact-form row columns_margin_bottom_40 topmargin_60" method="post" action="./">
                            ...
                            <div className="col-sm-6">
                                <div className="contact-form-date select-group">
                                    <label for="date" className="sr-only">Date
											<span className="required">*</span>
                                    </label>
                                    <div className="input-group">
                                        <select aria-required="true" id="date" name="date" className="choice empty form-control">
                            ...
                            <div className="col-sm-6">
                                <div className="contact-form-time select-group">
                                    <label for="time" className="sr-only">Date
											<span className="required">*</span>
                                    </label>
                                    <div className="input-group">
                                        <select aria-required="true" id="time" name="time" className="choice empty form-control">
